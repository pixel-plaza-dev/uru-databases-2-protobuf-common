...
var (
	...
	GetRefreshTokenInformation  = types.NewGRPCMethod("GetRefreshTokenInformation")
	GetRefreshTokensInformation = types.NewGRPCMethod("GetRefreshTokensInformation")
	RevokeRefreshToken          = types.NewGRPCMethod("RevokeRefreshToken")
	RevokeRefreshTokens         = types.NewGRPCMethod("RevokeRefreshTokens")
