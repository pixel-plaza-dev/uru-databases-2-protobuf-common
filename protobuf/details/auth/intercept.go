...
var GRPCInterceptions = map[types.GRPCMethod]types.Interception{
	...
	GetRefreshTokenInformation:  types.AccessToken,
	GetRefreshTokensInformation: types.AccessToken,
	RevokeRefreshToken:          types.AccessToken,
	RevokeRefreshTokens:         types.AccessToken,
